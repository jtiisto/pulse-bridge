...
from analysis.intent import IntervalIntent
from analysis.quality import Beat
from analysis.segment import Bout, detect_bouts
from analysis.vo2 import (
    ExpectedBout,
    _durations_for,
    _expected_bouts,
    _hr_at_or_before,
...
T0 = 1_700_000_000_000  # arbitrary epoch-ms anchor
