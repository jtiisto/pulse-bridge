...
import dev.jtiisto.pulsebridge.core.ble.connection.GarminHrmConnection
...
class BleCaptureService : Service() {
    ...
    companion object {
        ...
        const val ACTION_STOP = "dev.jtiisto.pulsebridge.STOP_CAPTURE"
        private const val WAKE_LOCK_TAG = "PulseBridge:BleCapture"
